  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400",
        brand: "border-transparent bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400",
